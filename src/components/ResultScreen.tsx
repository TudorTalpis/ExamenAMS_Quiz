  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md text-center">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mb-1">Sesiune completă!</h2>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 mb-6">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">Corecte</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-rose-500">{wrong}</p>
              <p className="text-xs text-slate-500 mt-1">Greșeli</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-indigo-600">{pct}%</p>
              <p className="text-xs text-slate-500 mt-1">Rată succes</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-white border-2 border-slate-200 text-slate-700
              font-medium hover:border-indigo-300 active:scale-95 transition-all duration-150"
          >
            🏠 Acasă
          </button>
        </div>
